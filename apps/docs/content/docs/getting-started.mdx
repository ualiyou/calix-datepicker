...
description: Copy a working popup picker or inline calendar after installation.
---

Before this page, [install Calix](/docs/installation) and, if you want the
included appearance, [add one stylesheet in the correct framework file](/docs/frameworks).
