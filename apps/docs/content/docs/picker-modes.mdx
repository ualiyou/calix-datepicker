---
title: Selection, time, and output
description: Choose the selected value shape, add time, and serialize it for an API.
---

Use this page after [your first picker](/docs/getting-started) when the default
...
Next: [constrain available dates and add holidays](/docs/holidays), or read the
[API Reference](/docs/api-reference) for the full prop list.
